...
first_message = "What is the weather in sf?"
...
print("-" * 100)
second_message = "What about in LA?"
...
print("-" * 100)
third_message = "Which one is warmer?"
messages = [HumanMessage(content=third_message)]
thread = {"configurable": {"thread_id": "1"}}
...
print("-" * 100)
print("Using a different thread")
third_message = "Which one is warmer?"
messages = [HumanMessage(content=third_message)]
