...
print("\nGetting state...")
current_values = research_agent.graph.get_state(thread)
print(current_values)
print("\nGetting state last message...")
print(current_values.values['messages'][-1])
print("\nGetting state last message tool calls...")
...
research_agent.graph.update_state(thread, current_values.values)

print("\nGetting state after update...")
current_values = research_agent.graph.get_state(thread)
print(current_values)
print("\nGetting state last message after update...")
print(current_values.values['messages'][-1])
print("\nGetting state last message tool calls after update...")
print(current_values.values['messages'][-1].tool_calls)
...
print("\nStates history...")
states = []
for state in research_agent.graph.get_state_history(thread):
    print(state)
    print('-' * 100)
    states.append(state)
...
print("\nTime traveling...")
for event in research_agent.graph.stream(None, to_replay.config):
    for v in event.values():
        print(v)
        print("-" * 100)
